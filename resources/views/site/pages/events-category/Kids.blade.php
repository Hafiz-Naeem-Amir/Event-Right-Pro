...
<meta name="keywords" content="category event page, Kids - Events, EventRight Pro, EventRight Pro Events, events page">
<link rel="canonical" href="Kids.html"/>
...
<meta property=":keywords" content="Kids - Events" />
...
<meta property="og:url" content="Kids.html" />
                                        ...
                                        <div class="">
                                                        ...
                                                        <a href="../4/Singing.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5    capitalize p-2 hover:bg-primary-light rounded-md w-full">Singing</a>
                                                                                                    ...
                                                                                                    <div class="flex items-left justify-left">
                                                        <a href="Kids.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5  text-primary capitalize p-2 bg-primary-light  capitalize p-2 hover:bg-primary-light rounded-md w-full">Kids</a>
                                                    </div>
                                                                                                    <div class="flex items-left justify-left">
