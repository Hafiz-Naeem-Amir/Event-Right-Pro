...
<head>
    <meta charset="utf-8">
    <link href="../../images/upload/63f4c15738e28.png" rel="icon" type="image/png">
    ...
    <meta name="keywords"
        content="category event page, At Night - Events, EventRight Pro, EventRight Pro Events, events page">
    <link rel="canonical" href="At%20Night.html" />
    ...
    <meta property=":keywords" content="At Night - Events" />
    ...
    <meta property="og:url" content="At%20Night.html" />
...
<body>
                    ...
                    <div class="container mx-auto px-4">
                        <div class="flex items-center justify-between py-4">
                            <div>
                                ...
                                <a href="../../index.html" class="object-cover ">
                                    <img src="../../images/upload/645e53bbf24a8.png" class="object-scale-down h-10 "
                                        alt="Logo">
                                </a>
                            </div>
                            <div class="sm:flex sm:items-center">
                                <ul class="navbar-nav flex space-x-4 xxsm:max-xl:hidden">
                                            ...
                                            <div
                                                ...
                                                <div class="rounded-md bg-white shadow-lg p-3">
                                                    <div class="">
                                                        ...
                                                        <div class="flex items-left justify-left">
                                                            <a href="At%20Night.html"
                                                                class="flex items-left text-base font-poppins font-normal leading-5  text-primary capitalize p-2 bg-primary-light  capitalize p-2 hover:bg-primary-light rounded-md w-full">At
                                                                Night</a>
                                                        </div>
                                                        <div class="flex items-left justify-left">
                                                        ...
                                                        <div class="flex items-left justify-left">
                                                            <a href="../13/Food%20Fest.html"
                                                                class="flex items-left text-base font-poppins font-normal leading-5    capitalize p-2 hover:bg-primary-light rounded-md w-full">Food
                                                                Fest</a>
                                                        </div>
                                                        <div class="flex items-left justify-left">
                                                            <a href="../../all-category.html"
                                                                class="flex items-left text-base font-poppins font-normal leading-5   capitalize p-2 hover:bg-primary-light rounded-md w-full">All
                                                                categories
                                                                <img src="../../image/right-dropdown.html"
                                                                    alt="" class=" ml-2 h-2 w-2 mt-2">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="xxsm:max-lg:hidden nav-item  ">
                                        <a href="../../contact.html"
                                            class="nav-link md:px-1 capitalize font-poppins font-normal text-base leading-6 text-gray absolute">Contact
                                            Us</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div>
                                    <form action="https://eventrights.saasmonks.in/user/search_event" method="post">
                                        <input type="hidden" name="_token"
                                            value="Xn0jd2DB6nV2j6yAvW6pHI80rxfvJ3ejUMKj5ZrM">
                                        <div class="relative">
                                            <div
                            ...
                            text-base leading-6 rounded-md mx-1 focus:outline-none xxsm:w-full sm:w-48 lg:w-50"
                                ...
                                <div class="sm:px-4 flex xxsm:flex-wrap justify-end mt-2 sm:mt-0">
                                    <a type="button" href="../../user/login.html"
                                        class="px-5 py-2 text-white bg-primary text-center font-poppins font-normal text-base leading-6 rounded-md">Sign
                                        In</a>
                                </div>
                        ...
                        <div class="hidden nav-content" id="nav-content">
                            <ul class="list-reset lg:flex gap-5 justify-end flex-1 items-center text-end pb-5">
                                ...
                                <li class="mt-2 nav-item ">
                                    <a href="../../contact.html"
                                        class="nav-link md:px-1 capitalize font-poppins font-normal text-base leading-6 text-gray">contact
                                        Us</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="mb-4 pt-4">
                                <ul class="flex flex-wrap -mb-px text-lg font-medium text-center events xmd:space-y-0 md:space-y-2 sm:space-y-2 xxsm:space-y-2"
                                    ...
                                    <li class="mr-2">
                                        ...
                                        <button
                                            id="online_events" data-tabs-target="#online" type="button"
                                    ...
                                    <li class="mr-2">
                                        <button
                                            class="inline-block z-20 px-5 py-3 rounded-md font-poppins shadow-md focus:outline-none relative"
                                            id="venue_events" data-tabs-target="#venue" type="button"
                                            role="tab" aria-controls="venue" aria-selected="false">Venue
                                            Events(0)</button>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="rounded-md bg-white shadow-lg p-3">
                                            <div class="">
                                                <div class="p-2 flex items-left justify-left">
                                                    <a type="button" href="At%20Night.html"
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"91774ffbc6934a36bd8527461b4d5784","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
