...
<meta name="keywords" content="category event page, Party - Events, EventRight Pro, EventRight Pro Events, events page">
...
<meta property=":keywords" content="Party - Events" />
                                ...
                                <div
                                    ...
                                    <div class="rounded-md bg-white shadow-lg p-3">
                                        <div class="">
                                                        ...
                                                        <a href="Party.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5  text-primary capitalize p-2 bg-primary-light  capitalize p-2 hover:bg-primary-light rounded-md w-full">Party</a>
                                                    </div>
                                                                                                    <div class="flex items-left justify-left">
                ...
                <ul class="flex flex-wrap -mb-px text-lg font-medium text-center events xmd:space-y-0 md:space-y-2 sm:space-y-2 xxsm:space-y-2"
                    ...
                    <li class="mr-2">
                        <button
                            ...
                            aria-selected="false">Online Events(1)</button>
                    </li>
                    <li class="mr-2">
                        <button
                            class="inline-block z-20 px-5 py-3 rounded-md font-poppins shadow-md focus:outline-none relative"
                            id="venue_events" data-tabs-target="#venue" type="button" role="tab" aria-controls="venue"
                            aria-selected="false">Venue Events(1)</button>
                    </li>
                </ul>
            </div>
                        <div id="myTabContent">
                <div class="hidden" id="events" role="tabpanel" aria-labelledby="all_events">
                    <div
                        class="grid gap-x-7 1xl:grid-cols-4 xl:grid-cols-4 xlg:grid-cols-4 xmd:grid-cols-2 xxmd:gap-y-7 xmd:gap-y-7 xxsm:gap-y-7 sm:grid-cols-1 sm:gap-y-7 msm:grid-cols-1 xxsm:grid-cols-1 justify-between pt-10 z-30 relative">
                                ...
                                <a href="../../event/1/virtual-cocktail-shake-up.html">
                                    <div class="relative capitalize">
                                        <img src="../../images/upload/63e37cbbd47f8.jfif" alt=""
                                    ...
                                    <p class="font-popping font-semibold text-xl leading-8 pt-2 w-[90%] truncate">Virtual Cocktail Shake-up</p>
                                ...
                                <div class="flex justify-between mt-7">
                                                                        <a type="button" id="EventDetails1"
                                        href="../../event/1/virtual-cocktail-shake-up.html"
                                        ...
                                        <i class="fa-solid fa-arrow-right w-3 h-3 mt-1.5 ml-2"></i>
                                                    ...
                                                    <div
                                class="shadow-2xl p-5 rounded-lg bg-white hover:scale-110 transition-all duration-500 cursor-pointer">
                                <a href="../../event/2/couples-campfire.html">
                                    <div class="relative capitalize">
                                        <img src="../../images/upload/64707a6fc9d91.png" alt=""
                                        class="h-40 rounded-lg w-full object-cover bg-cover ">
                                                                                        <span class="bg-danger text-center text-sm text-white py-1 px-2 rounded-bl-lg rounded-tr-lg absolute top-0 right-0">
                                                    sold out
                                                                                    </div>
                                    <p class="font-popping font-semibold text-xl leading-8 pt-2 w-[90%] truncate">Couple&#039;s Campfire</p>
                                    <p class="font-poppins font-normal text-base leading-6 text-gray pt-1">
                                        10 Feb 2023 -
                                        29 Feb 2028
                                    </p>
                                ...
                                <div class="flex justify-between mt-7">
                                                                        <a type="button" id="EventDetails2"
                                        href="../../event/2/couples-campfire.html"
                                        class="text-primary text-center font-poppins font-medium text-base leading-7 flex">View Details
                                        <i class="fa-solid fa-arrow-right w-3 h-3 mt-1.5 ml-2"></i>
                                    </a>
                                </div>
