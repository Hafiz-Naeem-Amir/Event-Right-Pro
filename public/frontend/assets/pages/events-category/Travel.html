...
<meta name="keywords" content="category event page, Travel - Events, EventRight Pro, EventRight Pro Events, events page">
...
<meta property=":keywords" content="Travel - Events" />
...
<meta property="og:url" content="Travel.html" />
                                        ...
                                        <div class="">
                                                        ...
                                                        <a href="../6/Events.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5    capitalize p-2 hover:bg-primary-light rounded-md w-full">Events</a>
                                                                                                    ...
                                                                                                    <div class="flex items-left justify-left">
                                                        <a href="Travel.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5  text-primary capitalize p-2 bg-primary-light  capitalize p-2 hover:bg-primary-light rounded-md w-full">Travel</a>
                                                    </div>
                                                                                                    <div class="flex items-left justify-left">
                ...
                <div
                    ...
                    <div class="rounded-md bg-white shadow-lg p-3">
                                ...
                                <div class="p-2 flex items-left justify-left">
                                    <a type="button" href="Travel.html"
