...
<meta name="keywords" content="category event page, Gaming - Events, EventRight Pro, EventRight Pro Events, events page">
<link rel="canonical" href="Gaming.html"/>
...
<meta property=":keywords" content="Gaming - Events" />
...
<meta property="og:url" content="Gaming.html" />
                                        ...
                                        <div class="">
                                                        ...
                                                        <a href="../2/At%20Night.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5    capitalize p-2 hover:bg-primary-light rounded-md w-full">At Night</a>
                                                                                                    ...
                                                                                                    <div class="flex items-left justify-left">
                                                        <a href="Gaming.html"
                                                            class="flex items-left text-base font-poppins font-normal leading-5  text-primary capitalize p-2 bg-primary-light  capitalize p-2 hover:bg-primary-light rounded-md w-full">Gaming</a>
                                                    </div>
                                                                                                    <div class="flex items-left justify-left">
                ...
                <div class="hidden" id="events" role="tabpanel" aria-labelledby="all_events">
                    <div
                        class="grid gap-x-7 1xl:grid-cols-4 xl:grid-cols-4 xlg:grid-cols-4 xmd:grid-cols-2 xxmd:gap-y-7 xmd:gap-y-7 xxsm:gap-y-7 sm:grid-cols-1 sm:gap-y-7 msm:grid-cols-1 xxsm:grid-cols-1 justify-between pt-10 z-30 relative">
                                ...
                                <a href="../../event/3/online-game-night.html">
                                    <div class="relative capitalize">
                                        <img src="../../images/upload/63e5ea549eef9.jpg" alt=""
                                    ...
                                    <p class="font-popping font-semibold text-xl leading-8 pt-2 w-[90%] truncate">Online Game Night</p>
                                ...
                                <div class="flex justify-between mt-7">
                                                                        <a type="button" id="EventDetails3"
                                        href="../../event/3/online-game-night.html"
                ...
                <div
                    ...
                    <div class="rounded-md bg-white shadow-lg p-3">
                                ...
                                <div class="p-2 flex items-left justify-left">
                                    <a type="button" href="Gaming.html"
